...
function NowPlaying({ isMobile }) {
  return (
    <div className='w-full h-full lg:w-1/3'>
      <div
        className={`bg-blue-400 w-full rounded-lg text-white inline-block text-center "bottom-[9rem]"
        }`}
      >
        ...
        <div className='bg-white h-full w-full rounded-lg text-black'>
          <div className='p-4 text-left'>
            ...
            <div className='mt-4'>
              ...
              <img className='w-full' src={song} alt='' />
            </div>
